...
//    event Transfer(address from, address to, uint256 amount);
    ...
    function transfer(address recipient, uint256 amount) external override returns (bool) {
        require(balances[msg.sender] >= amount, "Balance should be bigger then transfer amount");
    ...
    function transferFrom(address sender, address recipient, uint256 amount) external override returns (bool) {
        require(allowances[sender][msg.sender] >= amount, "Amount exceeds allowance");
//        require(balances[sender] >= amount, "Amount exceeds balance");
